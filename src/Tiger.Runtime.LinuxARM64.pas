...
//==============================================================================
// TTigerLinuxARM64Runtime - System
//==============================================================================

procedure TTigerLinuxARM64Runtime.AddSystem(const AIR: TTigerIR; const AOptLevel: Integer);
begin
  //----------------------------------------------------------------------------
...
//==============================================================================
// TTigerLinuxARM64Runtime - I/O
//==============================================================================

procedure TTigerLinuxARM64Runtime.AddIO(const AIR: TTigerIR);
begin
  //----------------------------------------------------------------------------
  // Tiger_InitConsole()
...
procedure TTigerLinuxARM64Runtime.AddStrings(const AIR: TTigerIR);
var
  LDeref: TTigerIRExpr;
begin
  //----------------------------------------------------------------------------
...
procedure TTigerLinuxARM64Runtime.AddTypes(const AIR: TTigerIR);
begin
...
procedure TTigerLinuxARM64Runtime.AddExceptions(const AIR: TTigerIR);
const
...
//==============================================================================
// TTigerLinuxARM64Runtime - Command Line
//==============================================================================

procedure TTigerLinuxARM64Runtime.AddCommandLine(const AIR: TTigerIR);
begin
  //----------------------------------------------------------------------------
