...
type
  ...
  //----------------------------------------------------------------------------
  // TTigerCOFFLinker - COFF/PE static linker implementation
  //----------------------------------------------------------------------------

  { TTigerCOFFLinker }
  TTigerCOFFLinker = class(TTigerLinker)
  private
...
constructor TTigerCOFFLinker.Create();
begin
  inherited Create();
...
destructor TTigerCOFFLinker.Destroy();
var
...
function TTigerCOFFLinker.ReadCOFFSymbolName(const AData: TBytes;
...
function TTigerCOFFLinker.ParseCOFFObject(const AData: TBytes;
...
procedure TTigerCOFFLinker.ParseARLibrary(const AData: TBytes;
...
function TTigerCOFFLinker.ClassifySection(const ASectionName: string;
  const ACharacteristics: Cardinal): TLinkerSectionKind;
begin
...
procedure TTigerCOFFLinker.BuildGlobalSymbolIndex();
var
  LI, LJ: Integer;
  LObj: TCOFFObject;
  LSym: TCOFFSymbol;
...
procedure TTigerCOFFLinker.SelectObject(const AObjectIndex: Integer;
  const AWorkList: TList<Integer>);
var
  LObj: TCOFFObject;
  LSym: TCOFFSymbol;
...
function TTigerCOFFLinker.AlignUp(const AValue: Cardinal;
...
procedure TTigerCOFFLinker.MergeSelectedObjects();
var
  LI, LJ: Integer;
  LObj: TCOFFObject;
  LSect: TCOFFSection;
...
procedure TTigerCOFFLinker.CollectRelocations();
var
  LI, LJ, LK, LM: Integer;
  LObj: TCOFFObject;
  LSect: TCOFFSection;
...
procedure TTigerCOFFLinker.AddObjectFile(const APath: string);
var
  LData: TBytes;
  LObj: TCOFFObject;
begin
...
procedure TTigerCOFFLinker.AddLibraryFile(const APath: string);
var
  LData: TBytes;
begin
  if not FileExists(APath) then
...
procedure TTigerCOFFLinker.AddObjectFromMemory(const AData: TBytes;
  const AName: string);
var
  LObj: TCOFFObject;
begin
...
procedure TTigerCOFFLinker.Resolve(const ANeededSymbols: TStrings);
var
  LI: Integer;
...
function TTigerCOFFLinker.GetMergedText(): TBytes;
begin
...
function TTigerCOFFLinker.GetMergedTextSize(): Cardinal;
begin
  Result := Cardinal(FMergedText.Size);
end;

function TTigerCOFFLinker.GetMergedRData(): TBytes;
begin
...
function TTigerCOFFLinker.GetMergedRDataSize(): Cardinal;
begin
  Result := Cardinal(FMergedRData.Size);
end;

function TTigerCOFFLinker.GetMergedData(): TBytes;
begin
...
function TTigerCOFFLinker.GetMergedDataSize(): Cardinal;
begin
  Result := Cardinal(FMergedData.Size);
end;

function TTigerCOFFLinker.GetMergedPData(): TBytes;
begin
...
function TTigerCOFFLinker.GetMergedPDataSize(): Cardinal;
begin
  Result := Cardinal(FMergedPData.Size);
end;

function TTigerCOFFLinker.GetMergedXData(): TBytes;
begin
...
function TTigerCOFFLinker.GetMergedXDataSize(): Cardinal;
begin
  Result := Cardinal(FMergedXData.Size);
end;

function TTigerCOFFLinker.GetResolvedSymbols(): TDictionary<string, TLinkerResolvedSymbol>;
begin
  Result := FResolvedSymbols;
end;

function TTigerCOFFLinker.GetUnresolvedSymbols(): TStringList;
begin
  Result := FUnresolvedSymbols;
end;

function TTigerCOFFLinker.GetPendingRelocations(): TList<TLinkerPendingReloc>;
begin
  Result := FPendingRelocs;
end;

function TTigerCOFFLinker.GetObjectCount(): Integer;
begin
  Result := FObjects.Count;
end;

function TTigerCOFFLinker.GetSelectedObjectCount(): Integer;
var
  LI: Integer;
begin
  Result := 0;
